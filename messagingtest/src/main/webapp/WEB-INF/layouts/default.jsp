...
<html>
<head>
<meta name="google-site-verification" content="s433y9OaxbIh9r7Kyn87cTGsuJAkS9baXy8jyVFY7M8" />
...
<script
	src="${contextRoot}/js/sockjs.min.js"></script>
...
<body>
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/"><img class="navbar-logo" src="${contextRoot}/img/navbar-logo.png" alt="OtherFreaks.com"></a>
		</div>
